    ...
    <ProductDetail>
      <div className="productHire-container">
        <div className="left">
          <div className="top">
            <div className="title">
              <h2 style={{ fontWeight: 500, fontSize: "17px" }}>hợp đồng</h2>
              <h2 style={{ color: "#008000", fontSize: "18px" }}>đã ký</h2>
              <h2 style={{ color: "#008000", fontSize: "18px" }}>otp: 7422</h2>
            </div>
            <div className="actions">
              ...
              <Button variant='contained' style={{ backgroundColor: "#1BB99A", fontWeight: "700" }}>Đổi</Button>
