            ...
            >
                <Box sx={styleBox}>
                    ...
                    <DialogContent sx={styleModal} >
                        ...
                        <Divider />
                        <div className='input' style={{ borderRadius: "6px", padding: "10px", marginTop: "20px" }}>
                        ...
                        <div style={{ padding: "10px", background: "rgb(222 255 223)", borderRadius: "6px", marginTop: "10px" }}>
                            <TextField
                                id="phone"
                                value={phone}
                                label="Số điện thoại"
